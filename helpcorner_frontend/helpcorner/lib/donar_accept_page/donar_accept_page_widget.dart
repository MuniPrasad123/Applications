...
import 'donar_accept_page_model.dart';
export 'donar_accept_page_model.dart';

class DonarAcceptPageWidget extends StatefulWidget {
  const DonarAcceptPageWidget({Key? key}) : super(key: key);

  @override
  _DonarAcceptPageWidgetState createState() => _DonarAcceptPageWidgetState();
}

class _DonarAcceptPageWidgetState extends State<DonarAcceptPageWidget> {
  late DonarAcceptPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DonarAcceptPageModel());
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.apiResultvzy =
                              await SendMessageToDistributorCall.call(
